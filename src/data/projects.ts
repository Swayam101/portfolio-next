...
const MY_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    repo: "https://github.com",
    overview:
      "Dukan is a minimal thrift-commerce platform focused on curated listings, inventory tracking, and streamlined checkout. Built for fast performance and mobile-first browsing, it demonstrates modern e-commerce patterns with Next.js and Vercel.",
    brief:
